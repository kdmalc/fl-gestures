...
def eval_on_testset_and_return_original_and_reconstructed(model, test_loader, criterion=nn.MSELoss(), batch_modulus=500, get_latent_representations=True, xy_testloader=False):
    model.eval()
    test_losses = []
    sample_data_lst = []
    reconstructions_lst = []
